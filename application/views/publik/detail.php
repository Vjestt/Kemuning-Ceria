...
<head>
	...
	<title>Paket Edukasi
		 - Wisata Outbound Kemuning Ceria</title>
	<link rel="shortcut icon" href="assets/png/LOGO.png" />
	<meta name="keywords" content="outbound kemuning, paket outbound kemuning, wisata kemuning, paket edukasi" />
...
<div class="carousel owl-carousel">
        ...
        <?php endforeach; ?>
			...
			<div class="container css-13">
				...
				<div class="chakra-stack css-14">
					...
					<h1 class="chakra-heading css-60"><?= $judul?></h1>
				
                    
					<p class="chakra-heading css-header">Ayo bermain dan seru-seruan bareng dalam outbound kemuning karanganyar, nikmati layanan berwisata yang seru dan asyik!</p>
				</div>
		...
		<div class="css-61">
			...
			<div class="chakra-container css-62">
			
				<div class="chakra-stack css-63">
					
					<h2 class="chakra-heading css-64"><?= $judul?></h2>
					
					<p class="chakra-text css-65"><?= $deskripsi?></p>
				</div>
				
				<div class="css-66">
				<?php foreach($konten as $content):?>
					<div class="chakra-card css-67">
						
						<div class="chakra-card__body css-68">
						
							<div class="css-69">
								
								<div class="css-70">
									
									<div class="chakra-stack css-71">
										
										<div class="chakra-aspect-ratio css-72"><img alt="" loading="lazy" decoding="async"
												data-nimg="fill"
												...
												sizes="100vw"
												src="<?= base_url('assets/img/content/').$content['foto'] ?>" /></div>
									</div>
									<div class="chakra-stack css-71">
										<div class="chakra-stack css-71">
											
											<h3 class="chakra-heading css-73"><?=$content['judul']?></h3>
										<span class="chakra-text css-74">IDR
												<?=$content['harga']?>K</span>
										</div>
										<div class="chakra-stack css-71">
											
											<!-- <p class="chakra-text css-75">Mininal 25 peserta</p> -->
                                            <?php  
                                                foreach($content['fasilitas'] as $fas) {?>
												
										<span class="css-76">
												<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
													focusable="false" class="chakra-icon css-77" height="1em" width="1em"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
												</svg>
                                                <span class="css-78"><?=$fas?></span>										
                                            </span>
								...
								<a class="chakra-button css-79"
									href="https://wa.me/085326600685">Booking
									Sekarang<span class="chakra-button__icon css-80"><svg stroke="currentColor" fill="currentColor"
											stroke-width="0" version="1.1" viewBox="0 0 16 16" aria-hidden="true" focusable="false"
								...
								<div class="css-70">
									<div class="chakra-stack css-71">
										<div class="chakra-aspect-ratio css-72"><img alt="" loading="lazy" decoding="async"
												...
												style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;object-fit:cover;object-position:center;color:transparent"
												sizes="100vw"
												srcSet="/_next/image?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=640&amp;q=75 640w, /_next/image?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=750&amp;q=75 750w, /_next/image?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=828&amp;q=75 828w, /_next/image?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=1080&amp;q=75 1080w, /_next/image?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=1200&amp;q=75 1200w, /_next/image?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=1920&amp;q=75 1920w, /_next/image?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=2048&amp;q=75 2048w, /_next/image?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=3840&amp;q=75 3840w"
												src="_next/image8cc3.jpg?url=%2Fassets%2Fjpg%2FIMG_2735.JPG&amp;w=3840&amp;q=75" /></div>
									</div>
									<div class="chakra-stack css-71">
										<div class="chakra-stack css-71">
											<h3 class="chakra-heading css-73">Edukasi 2</h3><span class="chakra-text css-74">IDR
												80K</span>
										</div>
										<div class="chakra-stack css-71">
											<p class="chakra-text css-75">Mininal 25 peserta</p><span class="css-76"><svg
													stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
													focusable="false" class="chakra-icon css-77" height="1em" width="1em"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
												</svg><span class="css-78">Tutor</span></span><span class="css-76"><svg
													stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
													focusable="false" class="chakra-icon css-77" height="1em" width="1em"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
												</svg><span class="css-78">Pemandu</span></span><span class="css-76"><svg
													stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
													focusable="false" class="chakra-icon css-77" height="1em" width="1em"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
												</svg><span class="css-78">Dokumentasi</span></span><span class="css-76"><svg
													stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
													focusable="false" class="chakra-icon css-77" height="1em" width="1em"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
												</svg><span class="css-78">Makan Siang</span></span><span class="css-76"><svg
													stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
													focusable="false" class="chakra-icon css-77" height="1em" width="1em"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path>
												</svg><span class="css-78">Oleh-oleh Teh Kemuning</span></span>
										</div>
									</div>
								</div><a class="chakra-button css-79"
									href="https://api.whatsapp.com/send?phone=6285326600685&amp;text=Halo%20admin%20Kemuning%20Ceria.%20Saya%20mau%20booking%20Paket%20Edukasi%202.%20Bisa%20minta%20detailnya?%3F">Booking
									Sekarang<span class="chakra-button__icon css-80"><svg stroke="currentColor" fill="currentColor"
											stroke-width="0" version="1.1" viewBox="0 0 16 16" aria-hidden="true" focusable="false"
											height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
											<path
		...
		<div class="galeri">
			...
			<div class="container css-33">
				...
				<div class="chakra-stack css-34">
				
					<h2 class="chakra-heading css-26">GALERI PHOTO</h2>
				</div>
				...
				<div class="css-35">
					...
					<div class="css-video">
						...
						<div class="container css-38">
							...
							<div class="chakra-aspect-ratio css-39"><iframe
									src="https://www.youtube.com/embed/ZnBH1iR0mU8"></iframe></div>
						</div>
					</div>
				</div>
			</div>
...
<!-- Mirrored from kemuningceria.com/paket-edukasi by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Nov 2024 06:41:58 GMT -->
