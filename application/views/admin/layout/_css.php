<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin/') ?>assets/plugins/select2/css/select2.min.css">

    <link rel="stylesheet" href="<?= base_url('assets/admin/') ?>assets/plugins/stickynote/sticky.css">

    <link rel="stylesheet" href="<?= base_url('assets/admin/') ?>assets/css/animate.css">

	<link rel="stylesheet" href="<?= base_url('assets/admin/') ?>assets/plugins/lightbox/glightbox.min.css">
